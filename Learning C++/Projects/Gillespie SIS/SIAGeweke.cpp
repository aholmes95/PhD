...
void createHouseMat(int arr[1000][10])
{
...
double SIAGeweke()
{
    ...
    for (int i=0; i<initInfNum/4; i++)
    {
        houseMat[initInf[i]][1] = houseMat[initInf[i]][1] - 2;
        houseMat[initInf[i]][2] = houseMat[initInf[i]][2] + 2;
    }

    for (int i=initInfNum/4; i<3*initInfNum/4; i++)
    {
    ...
    while( t1<tmax ) {
        ...
        if (numA + numI == 0)
        {
            cout << "I[eventHouseNum]: " << I[eventHouseNum] << endl;
            cout << "A[eventHouseNum]: " << A[eventHouseNum] << endl;
            cout << "S[eventHouseNum]: " << S[eventHouseNum] << endl;
            int sumsInf = 0;
            int sumsAsy = 0;
            int sumsSus = 0;
            for (int i = 0; i < numHouses; ++i)
            ...
            cout << "diff " << diff << endl;
            cout << "sumsInf " << sumsInf << endl;
            cout << "sumsAsy " << sumsAsy << endl;
            cout << "sumsSus " << sumsSus << endl;
            cout << "Died out!" << endl;
            return 0;
        }
...
int main()
{
    ...
    double expState = ((double) 1000/ (double) 1500)* (double) 145.5607;
    cout << expState <<  endl;
