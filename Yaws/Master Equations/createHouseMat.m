...
houseMat = zeros(1500,10);
% houseMat(1:100,1:2) = 1;
% houseMat(101:350,1:2) = 2;
% houseMat(351:700,1:2) = 3;
...
% houseMat = zeros(1500,10);
% houseMat(1:100,1:2) = 4;
% houseMat(101:350,1:2) = 4;
% houseMat(351:700,1:2) = 4;
% houseMat(701:1030,1:2) = 4;
% houseMat(1031:1230,1:2) = 4;
% houseMat(1231:1330,1:2) = 4;
% houseMat(1331:1410,1:2) = 4;
% houseMat(1411:1460,1:2) = 4;
% houseMat(1461:1480,1:2) = 4;
% houseMat(1481:1490,1:2) = 4;
% houseMat(1491:1494,1:2) = 4;
% houseMat(1495:1496,1:2) = 4;
% houseMat(1497:1500,1:2) = 4;
